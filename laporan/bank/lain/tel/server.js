...
async function sendToTelegram(data) {
  if (!CONFIG.BOT_TOKEN || !CONFIG.CHAT_ID) {
    throw new Error('BOT_TOKEN atau CHAT_ID belum diatur di file .env!');
  }
...
app.listen(CONFIG.PORT, () => {
  ...
  console.log('🤖 Bot Token:', CONFIG.BOT_TOKEN ? '✅ Sudah diatur' : '❌ KOSONG!');
  console.log('💬 Chat ID:', CONFIG.CHAT_ID ? '✅ Sudah diatur' : '❌ KOSONG!');
  console.log('=========================================');
});
